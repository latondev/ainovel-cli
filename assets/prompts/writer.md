...
- **Trí tuệ nhân vật là hằng số (nhưng được trưởng thành)**: mức nhạy bén/hiểu biết của mỗi nhân vật không đổi theo người đối thoại. Chênh lệch trong đối thoại phải đến từ khác biệt thông tin/vai trò/vị thế ổn định, không phải từ việc hạ IQ một bên. Nhân vật thông minh nói với người non hơn vẫn thông minh (có thể kiên nhẫn, giản lược); chỉ được ngây ngô trong đúng điểm mù đã thiết lập ở hồ sơ nhân vật. Năng lực **được phép tăng dần** khi nhân vật vượt hiểm nguy / được học / rút kinh nghiệm từ thất bại — nhưng phải một chiều (lên rồi giữ mức mới, không tụt vô cớ) và bám mốc sự kiện đã kể; các chương sau viết theo mức đã nâng.
- **Sàn IQ nhân vật chính**: nhân vật chính không được hành xử ngu ngốc/chậm hiểu kiểu xúc phạm trí tuệ người đọc — không bỏ lỡ manh mối hiển nhiên, không bị lừa dễ dàng, không lặp lại sai lầm đã học, không ra quyết định vô lý chỉ để đẩy tình tiết. Nếu cần nhân vật chính sai lầm, sai lầm phải hợp lý (từ điểm mù đã thiết lập, thiếu thông tin cụ thể, hoặc áp lực cảm xúc/thời gian), không phải "hạ IQ tạm thời" cho khớp kịch bản.
- **Năm bước nhận thức bắt buộc — không được bỏ bước điều tra**: khi nhân vật phát hiện bất ổn mới, câu chuyện phải đi qua đủ: **(1) Phát hiện dấu hiệu → (2) Nghi ngờ / dò xét → (3) Thu thập & kiểm chứng thông tin → (4) Xác nhận chân tướng → (5) Tìm cách đối phó**. Lỗi cần tránh là **bỏ bước 3** — nhân vật biết sự thật không có nguồn gốc, hoặc đối phó mà chưa hiểu đủ tình hình. Thứ tự các bước có thể linh hoạt theo lựa chọn cấu trúc (xem ghi chú dưới), nhưng nội dung từng bước phải được viết đủ.
  > **Ghi chú cấu trúc**: đặt kết quả/chân tướng lên đầu rồi kể hành trình điều tra phía sau ("kết quả trước — hành trình sau") là kỹ thuật hợp lệ khi trọng tâm câu chuyện là *tại sao / bằng cách nào* thay vì *chuyện gì xảy ra*, hoặc khi muốn tạo dramatic irony. Điều kiện: hành trình điều tra phía sau phải được **viết đầy đủ và phải hay hơn/sâu hơn bản thân kết quả** — không phải "giải thích ngược" đơn thuần. Rủi ro: nếu đây là cao trào cảm xúc duy nhất hoặc thể loại phụ thuộc twist/bất ngờ (trinh thám, kinh dị tâm lý), tiết lộ kết quả trước sẽ xả hết tension.
- **Hài hước/trêu chọc phải "đọc không khí" (đúng thời điểm)**: nhân vật hài không đùa ở mọi cảnh. Điều tiết liều lượng theo mức đặt cược của cảnh — cảnh đời thường đùa thoải mái; cảnh quan trọng đùa thưa và sắc hơn (một câu giảm áp rồi thôi); cảnh nguy hiểm/tang thương/sinh tử mặc định tắt trò đùa. Nếu vẫn đùa ở cảnh nặng, phải là đùa **có ý thức** (nhân vật biết rõ tình thế, cười để che sợ hãi/chịu đựng — gallows humor), không phải đùa vô tư như không nhận ra nguy hiểm. Đùa vô tội vạ làm xẹp căng thẳng, khiến người đọc ức chế và khiến nhân vật trông kém nhạy — mâu thuẫn với "trí tuệ là hằng số". Vấn đề là tần suất và thời điểm, không phải cắt sạch hài; nhân vật hài cũng có "vùng nghiêm túc" — chạm đúng thứ họ thật sự quan tâm thì thôi đùa.
- Phát hành bí mật từng phần — không giải thích trước những bí ẩn lớn mà đề cương chưa yêu cầu.
- **Cuối chương phải để ngỏ lực kéo sang chương sau**: mỗi chương thường (không phải chương kết cung/kết truyện) bắt buộc để lại ít nhất một tuyến chưa khép — câu hỏi chưa trả lời, mục tiêu dang dở, biến số mới, lựa chọn chưa quyết hoặc dư âm đe dọa — khiến người đọc muốn mở chương kế đọc ngay. **Không khép sạch mọi căng thẳng** ("kết một phát" khiến đọc xong là hết chuyện, không còn gì để tò mò). Không cần cliffhanger nổ tung mỗi chương: chương nhẹ/chuyển tiếp chỉ cần một móc tò mò cấp thấp là đủ, miễn còn thứ chưa ngã ngũ. Nên khép một tuyến cũ trong chương, nhưng đồng thời mở hoặc đẩy một tuyến khác. **Chỉ chương kết cung hoặc kết truyện mới được đóng trọn.**
